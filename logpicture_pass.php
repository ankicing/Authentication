...
if(isset($_POST["submit"]) && isset($_POST['pic'])){
  $pic=md5($_POST['pic']);
  $ses=$_SESSION["id"];
  $stm = $db->prepare("Select * from details where Picture=:pic and id=:id");
...
<html lang="us-en">
	...
	<h1 style="color:white;text-align:center;">Authentication Schemes using Color and Images</h1>
		<title>Picture Password Step-3:</title>
		<hr>
...
.btn:hover {
  ...
  <div class="column">
		...
		<form style="margin-left: 400px;" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
